...
1. Navigate to the `/registration-form` folder for today.
1. Open the entire folder in your text editor to follow along.
1. Open the `index.html` in your browser.

Note: anytime you see a :sparkles:emoji in the notes below, that indicates a styling block for the activity! 
